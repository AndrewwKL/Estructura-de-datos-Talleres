...
public class DocumentSearch {
    ...
    public static void buildInvertedIndex(String[] documents) {
    ...
    public static List<Integer> searchWord(String word) {
        if (cache.containsKey(word)) {
            return cache.get(word);
        }
        
        word = word.toLowerCase(); 
        List<Integer> result = invertedIndex.getOrDefault(word, new ArrayList<>());
    ...
    public static void main(String[] args) {
        ...
        buildInvertedIndex(myDocuments);

        String searchWord = "desarrollo"; 
        List<Integer> documentIndices = searchWord(searchWord);
        
        System.out.print(searchWord + ": [");
        for (int i = 0; i < documentIndices.size(); i++) {
            System.out.print(documentIndices.get(i)+1);
