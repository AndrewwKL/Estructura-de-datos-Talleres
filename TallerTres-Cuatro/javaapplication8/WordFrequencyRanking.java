...
public class WordFrequencyRanking {
    private static Map<String[], Map<String, Integer>> cache = new HashMap<>();

    public static Map<String, Integer> getWordFrequency(String[] documents) {
        if (cache.containsKey(documents)) {
        ...
        cache.put(documents, sortedWordFrequency);
    ...
    public static void main(String[] args) {
        ...
        Map<String, Integer> wordFrequency = getWordFrequency(myDocuments);
